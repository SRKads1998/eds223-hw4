...
```{r}
# filter out zone 5 from the wc_eez object
...
compareGeom(bathymetry_resample, sst_stack_mean)
...
suitibility_area_eez <- zonal(oysters_eez_area,
                              ...
                              fun = "sum",
                              na.rm = TRUE)
# join the suitable areas data w/ the original wc_eez object, and filter out zone 5 since much of the area is outside of the US
